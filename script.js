...
// Copy this file to firebaseConfig.js (gitignored), fill in your values,
// and import it — or use environment variables via your build tool.
...
function saveState() {
  ...
  _saveTimer = setTimeout(async () => {
    // Firestore doesn't support nested arrays — stringify them
    const state = {
